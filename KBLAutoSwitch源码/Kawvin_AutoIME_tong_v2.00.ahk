/* tong（【自动切换输入法键盘布局】）
	...
	清单：
		1.Kawvin_AutoIME_tong_v2.00.ahk 	必要		主脚本文件
		2.Kawvin_AutoIME.ini 				必要		配置文件
		3.get_keyboard.ahk					非必要	开启后可使用F10来获取当前的键盘布局代码
...
;【改编者信息】	;{
	...
	;-----配置文件
	; 	1.Kawvin_AutoIME.ini配置文件中设置相关选项，中文代码和英文代码已默认配置好，可使用get_keyboard.ahk获取键盘布局代码，目前微软自带英文键盘和搜狗输入法使用没有问题
